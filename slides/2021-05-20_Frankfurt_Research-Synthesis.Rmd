...
<br />
`r fa(name = "map-signs", fill="grey", height = "20px")`  __inferences__ we can draw from research syntheses __depend on the decisions__ in the research process<br /><span class="mysource">[@ioannidis.2016]</span>
<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;_e.g. "garbage in garbage out"_ <br /><span class="mysource">[@eggeretal.2001]</span>

<br /><br /><br />
`r fa(name = "search", fill="grey", height = "20px")` __transparency__ allow for critical evaluation & enhance reproducibility <br /><span class="mysource">[@wilson.2019]</span>

<br /><br /><br />
`r fa(name = "expand-arrows-alt", fill="grey", height = "20px")` __degrees of freedom__, e.g. in  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- literature search  
...
* __Open Science Practices__ help to make research transparent and reproducible<br /><span class="mysource">[@pageetal.2021]</span><br /><br />
...
* preregistration of research syntheses is __not standard__ procedure yet (outside of health)<br /><span class="mysource">[@ioannidis.2016; @molleretal.2018]</span>

## Existing solutions? | important frameworks


* PROSPERO <br /><span class="mysource">[@boothetal.2012]</span><br />
* PRISMA-P <br /><span class="mysource">[@moheretal.2015]</span><br />
* MARS <br /><span class="mysource">[@appelbaumetal.2018]</span><br /><br /><br />

`r fa(name = "exclamation-circle", fill="grey", height = "20px")` discipline-specific frameworks <br /><br /><br />

`r fa(name = "exclamation-circle", fill="grey", height = "20px")` "Preregistration is hard" <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;e.g. including power analysis, coding manual, data analysis strategy<span class="mysource">[@noseketal.2019]</span>
...
`r fa(name = "arrow-circle-right", fill="grey", height = "20px")` research syntheses on the topic of digitization<br /><br />
`r fa(name = "arrow-circle-right", fill="grey", height = "20px")` in teaching and teacher education
</div>
</div>
...
* utilize __existing__ frameworks and __standards__<br /><br />
* make them __accessible__ & __applicable__
  - for meta-analyses and systematic reviews 
  - for all disciplines<br /><br />
* enable __seamless integration__ of data analyses, files, figures, text, ...<br /><br />
* ensure __compatibility__ with markup languages<br /><br />

`r fa(name = "arrow-circle-right", fill="grey", height = "20px")` produce __standalone__ HTML/PDF
...
`r fa(name = "file-code", fill="grey", height = "20px")` include R __code__ and its __output__<br />
</span>
<span style="margin-left:50px;">
`r fa(name = "file-pdf", fill="grey", height = "20px")` encode __files__ (e.g. separate coding system)<br />
</span>
<span style="margin-left:50px;">
`r fa(name = "chart-area", fill="grey", height = "20px")` include __figures__, iframes, latex, ...<br />
</span>
<span style="margin-left:50px;">
`r fa(name = "hand-pointer", fill="grey", height = "20px")` include __interactive__ content (e.g. plotly)<br />
</span>
...
<br />
`r fa(name = "file-export", fill="grey", height = "30px")` compile to __standalone__ file
</div>
</div>
...
title page | icons from [fontawesome.com CC-BY 4.0](https://fontawesome.com/license/free)
</span>